                ...
                <div className="row">
                    <div className="col-lg-12 text-center">
                        ...
                        <p className="text-muted">
                            ...
                            Web Consortium (W3C) since 1999. SVG images and their behaviors are
                        ...
                        <ul className="timeline">
                                ...
                                <div className="timeline-panel">
                                    ...
                                    <div className="timeline-body">
                                        <p className="text-muted">
                                            ...
                                            The SVG 1.1 specification is modularized in order to
                                            allow subsets to be defined as profiles. Apart from
                                            this, there is very little difference between SVG 1.1
                                            and SVG 1.0.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <li>
                                ...
                                <div className="timeline-panel">
                                    ...
                                    <div className="timeline-body">
                                        <p className="text-muted">
                                            SVG Tiny 1.2 became a W3C Recommendation on 22 December
                                            2008. It was initially drafted as a profile of the
                                            planned SVG Full 1.2 (which has since been dropped in
                                            favor of SVG 2), but was later refactored as a
                            ...
                            <li className="timeline-inverted">
                                ...
                                <div className="timeline-panel">
                                    ...
                                    <div className="timeline-body">
                                        <p className="text-muted">
                                            SVG 1.1 Second Edition, which includes all the errata
                                            and clarifications, but no new features to the original
                                            SVG 1.1 was released on 16 August 2011.
                                        </p>
                                    </div>
                                </div>
                            </li>
